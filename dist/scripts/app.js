...
(function () {
	...
	/* modules */
	var parallaxInit = require('./parallax')(window, document);
	/* templates */
	var sceneTemplate = './templates/scene';

	var appContainer = document.getElementById('appContainer');
	var scene = appContainer.querySelector('#sceneContainer');
  ...
  */
	...
	for (var i = 0; i < layers.length; i++) {
		var newValue = 100 - i * 2;
		var newsize = newValue + '%';
		var newMargin = (100 - newValue) / 2 + '%';
...
},{"./parallax":2}],2:[function(require,module,exports){
'use strict';

module.exports = function (window, document, undefined) {
  console.warn('starting parallax');
  // Strict Mode
  'use strict';
